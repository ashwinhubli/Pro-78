...
export default class SignupLoginScreen extends React.Component {
  ...
  userSignUp = (emailId, password,confirmPassword) =>{
    if(password!==confirmPassword){
      return Alert.alert("The Password does not match/check your password!")
    }
    else{ 
...
const styles = StyleSheet.create({ 
  container:{
   ...
   modalTitle :{ justifyContent:'center', alignSelf:'center', fontSize:30, color:'#GHT322', margin:50 },
